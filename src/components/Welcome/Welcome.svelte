...
<div
	id="welcome"
	class="relative mt-24 h-[150vh] w-full bg-light p-10 pt-10 duration-300 dark:bg-dark md:mt-0"
...
>
	{#if isInView}
		<main class="z-0 flex h-full w-full flex-col justify-start gap-4">
			<!-- TEXT SECTION -->
			<div
				class="sticky left-0 top-[35%] mx-auto flex h-[130px] w-full flex-col justify-center gap-0 text-center font-Pretendard_ExtraLight text-xl text-font-lightDeepGreen duration-[0.6s] dark:text-font-darkBase md:top-[30%] md:h-[300px] md:gap-10 md:text-[3rem]"
				in:scale={{ duration: 500, start: 0, opacity: 0 }}
				out:fade={{ duration: 500 }}
			>
				<span
					>Welcome to <strong
						class="text-font-lightHighlightGreen1 dark:text-font-darkHighLightGreen1"
						>Alterim</strong
					> , where your</span
				>
				<span> PFP now has a story, </span>
				<span>a personality, and a life of its own </span>
			</div>

			<div
				class="sticky left-0 top-[55%] mx-auto flex h-14 w-[300px] items-center justify-center text-font-lightDeepGreen dark:text-font-darkBase md:top-[60%] md:h-20 3xl:w-[450px]"
			...
			>
				...
				>
					<span class="fade-out font-Pretendard_Regular text-xs dark:font-Pretendard_ExtraLight"
						>PFP</span
					>
				...
				>
					<span
						id="card-in-text"
						class="fade-out w-full text-center font-Pretendard_Regular text-xs duration-1000 dark:font-Pretendard_ExtraLight"
						>AI Soul</span
					>
