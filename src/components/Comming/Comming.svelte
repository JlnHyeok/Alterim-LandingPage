...
<div
	class="relative flex h-[120vh] w-full flex-col items-center justify-center gap-8 bg-light duration-300 dark:bg-dark md:flex-row md:gap-[90px]"
...
>
	...
	{#if isSmallSizeTitleView}
		<div
			class="relative items-center justify-start text-center font-Pretendard_Regular text-[32px] font-medium leading-[120%] text-font-lightDeepGreen dark:text-font-darkBase md:hidden md:text-left"
		...
		<div class="relative flex shrink-0 flex-col items-start justify-start gap-[72px]">
			<div class="relative flex w-[400px] shrink-0 flex-col items-start justify-start gap-[46px]">
				...
				<div
					class="relative hidden items-center justify-start text-left font-Pretendard_Regular text-[32px] font-medium leading-[120%] text-font-lightDeepGreen dark:text-font-darkBase md:flex"
					in:fade={{ duration: 1000, delay: 0 }}
					out:fade={{ duration: 1000, delay: 0 }}
				>
					I am here,<br />waiting for you!
				...
				<!-- DESCRIPTION SECTION -->
				<p
					class="relative mx-auto flex w-[80%] items-center justify-start self-stretch text-left font-Pretendard_Light text-base font-light leading-[140%] text-font-lightDeepGreen dark:text-font-darkBase md:mx-0 md:w-full"
					in:fade={{ duration: 1000, delay: 1000 }}
					out:fade={{ duration: 1000, delay: 0 }}
				>
			...
			<div
				class="relative mx-auto flex w-[200px] shrink-0 flex-row items-center justify-center overflow-hidden rounded-[40px] bg-font-lightDeepGreen py-2 dark:bg-white md:mx-0"
				style="box-shadow: 0px 9px 34px 0px rgba(212, 212, 212, 0.50); "
				in:fade={{ duration: 1000, delay: 2000 }}
				out:fade={{ duration: 1000, delay: 0 }}
			>
				<div
					class="pointer-events-none relative text-center font-Pretendard_Regular text-lg font-normal text-font-darkBase dark:text-[#020202]"
				>
					Coming Soon
				</div>
			</div>
